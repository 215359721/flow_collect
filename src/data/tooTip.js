function getTooTipHTML(node) {
  ...
  <div class="content" style="padding: 0px;background-color: rgb(255, 255, 255);z-index:7;">
          ...
          <div class="desc-part" style="height: 60px;margin-top: 5px;padding-left: 10px;overflow: auto;">
            ...
            <div class="content" style="height: 40px;color: #9a9a9a;font-size: 12px;padding-left: 0px !important;">${'部门:' + node.deptName + '|type:' + node.type + '|weekno:' + node.weekNo}</div>
          </div>
        </div>
  `
}
export default getTooTipHTML